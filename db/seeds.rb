...
puts "Creating users"
              User.create(:email => "admin@admin.com",          :name => "Admin",           :user_role_id => admin_role.id,     :password => "pinhead", :password_confirmation => "pinhead")
owner =       User.create(:email => "owner@owner.com",          :name => "Owner",           :user_role_id => owner_role.id,     :password => "pinhead", :password_confirmation => "pinhead")
publisher =   User.create(:email => "publisher@publisher.com",  :name => "Publisher",       :user_role_id => publisher_role.id, :password => "pinhead", :password_confirmation => "pinhead")
charlie =     User.create :email => "charliegodsoe@gmail.com",  :name => "Charlie Godsoe",  :user_role_id => owner_role.id,     :password => "pinhead", :password_confirmation => "pinhead"
...
TimeEntryQuality.create(:name => "currently_updated",     :description => "Recently a Tee Time was added",    :time_in_minutes => 24*60,      :display_name => "Current Updates")
TimeEntryQuality.create(:name => "not_recently_updated",  :description => "Updated a day ago",                :time_in_minutes => 2*24*60,    :display_name => "Not Updated Today")
TimeEntryQuality.create(:name => "data_expired",          :description => "Updated greater than 2 days ago",  :time_in_minutes => 2147483647, :display_name => "Not Updated for >2 days")
TimeEntryQuality.create(:name => "no_data", :description => "No tee times added", :time_in_minutes => nil, :display_name => nil)
